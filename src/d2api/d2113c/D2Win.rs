...
pub mod MsgHandler {
    ...
    pub fn RegisterMsgHandler(hwnd: HWND, msg_type: u32, msg: u32, handler: StormMsgHandler) {
        addr_to_fastcall(
            RegisterMsgHandler,
            AddressTable.MsgHandler.RegisterMsgHandler,
        )(hwnd, msg_type, msg, handler)
    }
}
...
pub mod Text {
    ...
    pub fn GetTextDimensions(text: PCWSTR) -> (i32, i32) {
        ...
        addr_to_fastcall(_GetTextDimensions, AddressTable.Text.GetTextDimensions)(
            text,
            &mut width,
            &mut height,
        );
    ...
    pub fn DrawBoxText(
        ...
        addr_to_fastcall(DrawBoxText, AddressTable.Text.DrawBoxText)(
            text, x, y, boxColor, drawMode, textColor,
        )
    }
